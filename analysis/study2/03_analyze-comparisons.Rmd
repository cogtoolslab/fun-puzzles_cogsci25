...
```{r}
# df.bootElo <- readRDS(here(data_path, 'bootElo.Rds'))
...
elos <- read_csv(here(csv_path, 'production2_participant-mElo-long.csv'))
elos %>%
  filter(condition == "difficult") %>%
...
ggsave(here(plot_path, str_c(experimentName, "_ELO-change.pdf")),
            dpi=300,
