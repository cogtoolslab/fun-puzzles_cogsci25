var jsPsychCanvasSliderResponse = (function (jspsych) {
  ...
  class CanvasSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      var html = '<div id="jspsych-canvas-slider-response-wrapper">';
      html += '<div id="jspsych-canvas-slider-response-stimulus" style="margin-bottom: 30px"><canvas id="jspsych-canvas-stimulus" height="' + trial.canvas_size[0] + '" width="' + trial.canvas_size[1] + '"></canvas></div>';
